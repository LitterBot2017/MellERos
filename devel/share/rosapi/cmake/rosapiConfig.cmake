...
if("TRUE" STREQUAL "TRUE")
  set(rosapi_SOURCE_PREFIX /home/nima/Code/Ros/melle_ws/src/rosbridge_suite/rosapi)
  set(rosapi_DEVEL_PREFIX /home/nima/Code/Ros/melle_ws/devel)
  set(rosapi_INSTALL_PREFIX "")
  set(rosapi_PREFIX ${rosapi_DEVEL_PREFIX})
else()
  set(rosapi_SOURCE_PREFIX "")
  set(rosapi_DEVEL_PREFIX "")
  set(rosapi_INSTALL_PREFIX /home/nima/Code/Ros/melle_ws/install)
...
if(NOT "/home/nima/Code/Ros/melle_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosapi' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nima/Code/Ros/melle_ws/src/rosbridge_suite/rosapi/${idir}'.  Ask the maintainer 'Russell Toris <rctoris@wpi.edu>, Jihoon Lee <jihoonlee.in@gmail.com>' to fix it.")
    endif()
