...
if("FALSE" STREQUAL "TRUE")
  set(rosbridge_server_SOURCE_PREFIX /home/nima/Code/Ros/melle_ws/src/rosbridge_suite/rosbridge_server)
  set(rosbridge_server_DEVEL_PREFIX /home/nima/Code/Ros/melle_ws/devel)
  ...
  set(rosbridge_server_INSTALL_PREFIX /home/nima/Code/Ros/melle_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbridge_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nima/Code/Ros/melle_ws/install/${idir}'.  Ask the maintainer 'Russell Toris <rctoris@wpi.edu>, Jihoon Lee <jihoonlee.in@gmail.com>' to fix it.")
    endif()
